...
NODE_POOL_NAME=currencyservice
...
gcloud container node-pools create currencyservice  --cluster testing-cluster --enable-autoscaling --num-nodes=1 --min-nodes=1 --max-nodes=6 --machine-type=e2-standard-2 --node-labels=type=currency
